...
<script>
  ...
  gtag('config', 'UA-110096683-1');
	...
	<script src="https://zapalgo.com/wp-content/themes/ultrabootstrap-child-theme-01/jquery.jscroll.min.js"></script>
...
<script type="text/javascript">
    ...
    <script src="https://zapalgo.com/wp-content/themes/ultrabootstrap-child-theme-01/js/slick.min.js"></script>
<style>
...
.carousel-inner>.item>img, .carousel-inner>.item>a>img {
	...
	<link rel="stylesheet" href="<?php echo bloginfo('url')."/wp-content/themes/ultrabootstrap-child-theme-01"; ?>/custom.css?ver3"/>
	<link rel="stylesheet" href="<?php echo bloginfo('url')."/wp-content/themes/ultrabootstrap-child-theme-01"; ?>/custom2.css?ver3"/>
	<link rel="stylesheet" href="<?php echo bloginfo('url')."/wp-content/themes/ultrabootstrap-child-theme-01"; ?>/woostyles.css"/>
	<link rel="stylesheet" href="<?php echo bloginfo('url')."/wp-content/themes/ultrabootstrap-child-theme-01"; ?>/custom-rwd.css?ver3"/>
</head>
