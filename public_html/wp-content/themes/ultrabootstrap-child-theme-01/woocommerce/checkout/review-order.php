...
<table class="shop_table woocommerce-checkout-review-order-table">
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						<td class="product-name">
                        	<div class="pt-image pull-left">
							<?php echo apply_filters( 'woocommerce_cart_item_name', $_product->get_image(), $cart_item, $cart_item_key ) . '&nbsp;'; ?>
                            </div>
                            <div class="pt-title">
                            ...
                            <div class="pt-qty row">
								...
								<?php echo apply_filters( 'woocommerce_checkout_cart_item_quantity', ' <strong class="product-quantity">' . sprintf( 'Quantity: %s', $cart_item['quantity'] ) . '</strong>', $cart_item, $cart_item_key ); ?>
                            </div>
						</td>
	...
	<tfoot>
		...
		<?php // oryginalne miejsce Shipping Method ?>
