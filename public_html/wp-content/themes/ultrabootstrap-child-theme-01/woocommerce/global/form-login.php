...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row form-row-first">
		<input type="text" class="input-text" name="username" id="username" placeholder="<?php _e( 'Email / Username', 'woocommerce' ); ?>" />
	</p>
    ...
    <p class="signup">Don't have an account? 
		<a href="<?php bloginfo('url'); ?>/my-account"><?php _e( 'Sign up', 'woocommerce' ); ?></a>
	</p>
