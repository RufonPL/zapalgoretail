...
$('.readmore').click(function(){
	...
	$(document).ready(function() { 
		jQuery(".login-custom #user_login").attr('placeholder', 'User Name');
          ...
          <li class="navbar-right dropdown">
			  ...
			  <div class="dropdown-menu category-overlay" aria-labelledby="dropdownMenuLink">
					<div class="container text-center">
						<div class="row">
							<div class="col-xs-4">
			    				<a href="<?php the_permalink(); ?>?cc=eur" class="currency-button<?php if($_SESSION['CC'] == 'EUR') : ?> active<?php endif; ?>">EUR</a>
			    			</div>
							<div class="col-xs-4">
			    				<a href="<?php the_permalink(); ?>?cc=usd" class="currency-button<?php if($_SESSION['CC'] == 'USD') : ?> active<?php endif; ?>">USD</a>
			    			</div>
							<div class="col-xs-4">
			    				<a href="<?php the_permalink(); ?>?cc=pln" class="currency-button<?php if($_SESSION['CC'] == 'PLN') : ?> active<?php endif; ?>">PLN</a>
			    			</div>
			    		</div>
			    	</div>
			  </div>
